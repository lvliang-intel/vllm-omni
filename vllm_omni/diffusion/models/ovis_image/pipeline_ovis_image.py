...
def _get_layer_quant_config(quant_config: Any) -> Any:
    if quant_config is None:
        return None
    getter = getattr(quant_config, "get_vllm_quant_config", None)
    if callable(getter):
        return getter()
    return quant_config
    ...
    def __init__(
        ...
        *,
        ...
        self.transformer = OvisImageTransformer2DModel(
            od_config=od_config,
            quant_config=_get_layer_quant_config(od_config.quantization_config),
        )
